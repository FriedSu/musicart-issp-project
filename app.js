...
var cors = require('cors'); // Allows to use resources outside of the local domain
var querystring = require('querystring'); // The data located in the url
...
app.get('/login', function(req, res) {
  ...
  // application requests authorization and grants access to the scope
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        // current user's profile printed in console
        var options = {
